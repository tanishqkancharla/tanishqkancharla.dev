(() => {
  ...
  var Node = function Node2(type, attrs, content2, marks3) {
    this.type = type;
    this.attrs = attrs;
  ...
  Node.prototype.canReplaceWith = function canReplaceWith(from4, to, type, marks3) {
  ...
  Node.fromJSON = function fromJSON4(schema2, json) {
    ...
    return schema2.nodeType(json.type).create(json.attrs, content2, marks3);
  };
  Object.defineProperties(Node.prototype, prototypeAccessors$3);
  var TextNode = /* @__PURE__ */ function(Node3) {
    function TextNode2(type, attrs, content2, marks3) {
  ...
  NodeType.prototype.create = function create(attrs, content2, marks3) {
    if (this.isText) {
      throw new Error("NodeType.create can't construct text nodes");
    }
    return new Node(this, this.computeAttrs(attrs), Fragment.from(content2), Mark.setFrom(marks3));
  };
  NodeType.prototype.createChecked = function createChecked(attrs, content2, marks3) {
    content2 = Fragment.from(content2);
    if (!this.validContent(content2)) {
      throw new RangeError("Invalid content for node " + this.name);
    }
    return new Node(this, this.computeAttrs(attrs), content2, Mark.setFrom(marks3));
  };
  NodeType.prototype.createAndFill = function createAndFill(attrs, content2, marks3) {
    ...
    return new Node(this, attrs, content2.append(after2), Mark.setFrom(marks3));
  };
  ...
  NodeType.prototype.allowedMarks = function allowedMarks(marks3) {
    ...
    for (var i = 0; i < marks3.length; i++) {
      if (!this.allowsMarkType(marks3[i].type)) {
        if (!copy5) {
          copy5 = marks3.slice(0, i);
        }
      } else if (copy5) {
        copy5.push(marks3[i]);
      }
    }
    return !copy5 ? marks3 : copy5.length ? copy5 : Mark.empty;
  };
  ...
  Schema.prototype.node = function node2(type, attrs, content2, marks3) {
    ...
    return type.createChecked(attrs, content2, marks3);
  };
  ...
  function gatherMarks(schema2, marks3) {
    var found2 = [];
    for (var i = 0; i < marks3.length; i++) {
      var name = marks3[i], mark3 = schema2.marks[name], ok2 = mark3;
      if (mark3) {
        found2.push(mark3);
      } else {
  ...
  ParseContext.prototype.addDOM = function addDOM(dom) {
    if (dom.nodeType == 3) {
      ...
      var marks3 = style ? this.readStyles(parseStyles(style)) : null, top = this.top;
      if (marks3 != null) {
        for (var i = 0; i < marks3.length; i++) {
      ...
      if (marks3 != null) {
        for (var i$1 = 0; i$1 < marks3.length; i$1++) {
          this.removePendingMark(marks3[i$1], top);
        }
      }
    }
  };
  ...
  ParseContext.prototype.insertNode = function insertNode(node4) {
    ...
    if (this.findPlace(node4)) {
      ...
      var marks3 = top.activeMarks;
      for (var i = 0; i < node4.marks.length; i++) {
        if (!top.type || top.type.allowsMarkType(node4.marks[i].type)) {
          marks3 = node4.marks[i].addToSet(marks3);
        }
      }
      top.content.push(node4.mark(marks3));
      return true;
    }
    return false;
  };
  ...
  Transform.prototype.setNodeMarkup = function(pos, type, attrs, marks3) {
    ...
    var newNode = type.create(attrs, null, marks3 || node4.marks);
    if (node4.isLeaf) {
      ...
      if (!mark3.isInSet(marks3) && parent.type.allowsMarkType(mark3.type)) {
        ...
        for (var i = 0; i < marks3.length; i++) {
          if (!marks3[i].isInSet(newSet)) {
            if (removing && removing.to == start3 && removing.mark.eq(marks3[i])) {
              removing.to = end2;
            } else {
              removed.push(removing = new RemoveMarkStep(start3, end2, marks3[i]));
            }
          }
        }
  ...
  var TextSelection = /* @__PURE__ */ function(Selection3) {
    ...
    if (Selection3)
      TextSelection3.__proto__ = Selection3;
    TextSelection3.prototype = Object.create(Selection3 && Selection3.prototype);
    ...
    TextSelection3.prototype.map = function map14(doc2, mapping) {
    ...
    TextSelection3.prototype.replace = function replace3(tr, content2) {
      if (content2 === void 0)
        content2 = Slice.empty;
    ...
    TextSelection3.prototype.eq = function eq12(other) {
      return other instanceof TextSelection3 && other.anchor == this.anchor && other.head == this.head;
    };
    TextSelection3.prototype.getBookmark = function getBookmark2() {
      return new TextBookmark(this.anchor, this.head);
    };
    TextSelection3.prototype.toJSON = function toJSON7() {
      return {type: "text", anchor: this.anchor, head: this.head};
    };
    TextSelection3.fromJSON = function fromJSON8(doc2, json) {
      if (typeof json.anchor != "number" || typeof json.head != "number") {
        throw new RangeError("Invalid input for TextSelection.fromJSON");
      }
      return new TextSelection3(doc2.resolve(json.anchor), doc2.resolve(json.head));
    };
    TextSelection3.create = function create5(doc2, anchor, head) {
      if (head === void 0)
        head = anchor;
    ...
    Object.defineProperties(TextSelection3.prototype, prototypeAccessors$15);
    ...
    Transaction2.prototype.insertText = function insertText(text2, from4, to) {
      ...
      if (from4 == null) {
        ...
        if (!marks3) {
          ...
          marks3 = to == from4 ? $from.marks() : $from.marksAcross(this.doc.resolve(to));
        }
        this.replaceRangeWith(from4, to, schema2.text(text2, marks3));
  ...
  ViewTreeUpdater.prototype.syncToMarks = function syncToMarks(marks3, inline2, view2) {
    ...
    while (depth < marks3.length) {
      ...
      if (found2 > -1) {
        ...
        var markDesc = MarkViewDesc.create(this.top, marks3[depth], inline2, view2);
  ...
  var markdownInputRules = inputRules({rules: [bold, italic, code]});
  ...
  var Cursor = class {
    ...
    repositionAnchor(x, y) {
      this.#anchorEl.style.transform = `translate(${x - 2}px, ${window.scrollY + y - 4}px)`;
      return this;
    }
    repositionHead(x, y) {
      this.#headEl.style.transform = `translate(${x - 2}px, ${window.scrollY + y - 4}px)`;
      return this;
    }
